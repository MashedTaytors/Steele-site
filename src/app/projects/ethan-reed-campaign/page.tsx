...
export default function Reed() {
  return (
    <div className="flex flex-col items-start justify-between gap-8">
      <div className="flex flex-col gap-6 leading-relaxed font-sourceCodePro text-secondaryText w-full">
        {/* Title & intro */}
        <div className="flex flex-col gap-3">
          ...
          <p className="text-base leading-relaxed text-tertiaryText">
            ...
            championed a successful campaign for a seat on the Eau Claire City Council. Early on, I joined his
            campaign as the Web & Brand Development Manager, where I designed
            and implemented a multimedia marketing strategy to showcase his
            platform and vision for the community. This included establishing a
            consistent brand identity, creating designs for both digital and
            print media, and building the{" "}
            <a
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs leading-relaxed text-secondaryText">
            ...
            the people-first values at the heart of Ethan&apos;s
            policies—ensuring local government reflects the voices, needs, and
          ...
          <p className="text-xs leading-relaxed text-secondaryText">
            I created guides for future use on the campaign to ensure
            consistency. The section below features the color palette and
            typography scale for the campaign's brand. The layout of the palette
            is intended to convey the color balance used throughout the brand.
          </p>
          ...
          <p className="text-xs leading-relaxed text-secondaryText">
            literature for door knocking, postcards, and yard signs
          </p>

          <div className="flex flex-col bg-slateGrey rounded-lg gap-6 p-4">
            {/* Print Media */}
            <Image
              src="/reedAssets/reedDoorLit.png"
              alt="Door literature for the Ethan Reed for Eau Claire City Council Campaign, split into two vertical sections. 
