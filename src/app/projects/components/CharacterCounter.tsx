...
const CharacterCounter: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-64 w-full justify-between rounded-lg bg-transparent border border-solid border-gray-500 border-opacity-40 lg:flex-row">
