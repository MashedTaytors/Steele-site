...
export default function ProjectsSidebar(): JSX.Element {
    ...
    return (
        <div className="flex flex-col sticky overflow-y-scroll top-24 border-gray-500 border-opacity-40 gap-2 h-32 border-b md:w-1/3 md:min-h-[calc(100vh-4rem)] md:border-r md:border-b-0 lg:w-1/4">
            {links.map((link) => {
